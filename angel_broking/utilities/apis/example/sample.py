...
from smart_api import SmartConnect  # or from smartapi.smartConnect import SmartConnect
from angel_broking.utilities.apis.smart_api.web_socket import WebSocket
